...
import 'package:textspeech/util/config/themes/app_dark_theme.dart';
import 'package:textspeech/util/config/themes/app_light_theme.dart';
import 'package:textspeech/util/config/themes/ui_themes.dart';
...
const mainGradientLight = LinearGradient(
    ...
    colors: [
      aksenLightColorLight,
      primaryLightColorLight,
      secondaryColorLight,
      primaryColorLight,
      lastColorLight,
      aksenColorLight,
      secondaryLightColorLight,
    ]);

const mainGradientDark = LinearGradient(
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
    colors: [primaryDarkColorDark, primarColorDark]);

LinearGradient mainGradient(BuildContext context) =>
    UIThemes.isDarkMode(context) ? mainGradientDark : mainGradientLight;
